 ...
 *
 * Verdiene er representative for en lysbueovn i 100-tonnsklassen med
 * conveyor-mating og forvarming, og er valgt for å gi plausibel dynamikk.
 * De er ikke hentet fra et bestemt anlegg, og bør kalibreres mot faktiske
 * driftsdata før modellen brukes til annet enn prosedyretrening.
 */
...
// Gir 1504 °C ved 0,20 %C og 1462 °C ved 0,80 %C
...
// trenger margin for legeringstilsats
export const TAP_SUPERHEAT_TARGET_C = 120.0;
export const TAP_SUPERHEAT_WINDOW_C = 20.0;
export const LADLE_TEMP_DROP_C_PER_MIN = 1.3; // tommelfingerregel for temperaturfall i øse
export const BATH_TEMP_CRITICAL_C = 1720.0; // for varmt stål sliter mye fortere på ildfast

// Ildfastslitasje: normal drift bruker opp potta over mange charger, mens
// overoppheting tærer den ned på minutter
export const REFRACTORY_BASE_WEAR_PER_S = 0.000006;
export const REFRACTORY_HOT_WEAR_PER_K_S = 0.0000033;

// --- Ovn og charge ----------------------------------------------------------
export const CHARGE_SCRAP_MASS_KG = 92_000.0; // en skrapkasse = en charge
export const HEEL_MASS_KG = 25_000.0; // stålsump som står igjen etter tapping
export const TAP_HOLE_DRAIN_KG_S = 450.0;

// --- Conveyor og forvarming -------------------------------------------------
export const CONVEYOR_MAX_RATE_T_MIN = 3.5;
export const OFFGAS_NOMINAL_TEMP_C = 800.0;
export const OFFGAS_MAX_TEMP_C = 1200.0;
export const PREHEAT_MAX_TEMP_C = 550.0;
export const STATIC_SEAL_FALSE_AIR_PENALTY = 0.45; // tap av forvarmingseffekt ved falskluft
...
export const FOAM_SHIELD_MAX_REDUCTION = 0.45; // skumslagg isolerer lysbuen
...
export const CARBON_INJECTION_MAX_KG_MIN = 120.0; // antrasitt/gummigranulat via injeksjonslansene
export const OXYGEN_MAX_NM3_H = 4500.0; // oksygenlanser

// --- Slaggmål ---------------------------------------------------------------
export const B2_TARGET = 1.8; // CaO / SiO2
export const B3_TARGET = 1.25; // CaO / (SiO2 + Al2O3)
export const B2_WINDOW = 0.35;
export const FEO_TARGET_PCT = 25.0; // typisk nivå i skumslagg på lysbueovn

// Oksider som følger med skrapet (smuss, rust, sand) og ildfastslitasje, kg per kg skrap.
// Kalibrert slik at en normalt kjørt charge havner innenfor det som er vanlig for
// basisk skumslagg: CaO rundt 25-30, SiO2 13-18, FeO 25-30, MgO 8-11 wt%.
...
export const PHOSPHORUS_FROM_SCRAP_PCT = 0.035; // fosfor kommer inn med skrapet
...
// --- Tipping ----------------------------------------------------------------
export const SLAG_POSITION_DEG = -12.0; // tipping mot slaggdør for avslagging
export const TAP_POSITION_DEG = 14.0; // tipping mot øsedørken for tapping
